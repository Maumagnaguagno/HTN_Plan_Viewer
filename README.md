...
Each generated plan modifies the URL to simplify sharing.  
...
To load from a planner output file, [limited by CORS policy](https://en.wikipedia.org/wiki/Cross-origin_resource_sharing):

```
https://maumagnaguagno.github.io/HTN_Plan_Viewer?from=/HTN_Plan_Viewer/plan.txt
```
